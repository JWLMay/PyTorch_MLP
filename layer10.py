...
fig.suptitle('Accuray/Loss of layer10')
ax1.plot(Compute.accu_data)
ax2.plot(Compute.loss_data)
ax1.set(xlabel = 'epochs', ylabel = 'accuracy')
ax2.set(xlabel = 'epochs', ylabel = 'loss')
plt.show()
print('accuracy : ' + str(Compute.accu_data.max()) + '%')
...
import pickle
with open(file='layer10_accu.pickle', mode='wb') as f:
    pickle.dump(Compute.accu_data, f)
with open(file='layer10_loss.pickle', mode='wb') as f:
